...
import { useSendSmsCode, usePhoneRegister } from '../../hooks/useAuth';
import './PhoneLoginPage.css'; // 复用登录页样式
...
const RegisterPage: React.FC = () => {
  ...
  const { register, isLoading, error: registerError } = usePhoneRegister();
  ...
  const handleRegister = async () => {
    ...
    const success = await register(phone, code, nickname || undefined);
    if (success) {
        ...
        <div className="phone-login-container">
          ...
          <div className="form-section">
            ...
            <div className="input-group">
              <div className="input-label">昵称（选填）</div>
            ...
            >
              {isLoading ? <IonSpinner name="crescent" /> : '注册'}
            </IonButton>
