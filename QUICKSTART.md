...
2. **配置 AI 功能**: 在 `.env` 中添加 `OPENAI_API_KEY`
3. **开发新功能**: 参考 [开发指南](README.md#开发指南)
4. **部署到生产**: 参考 `deployment.md`
...
**需要帮助？** 查看 [常见问题](README.md#常见问题) 或提交 [Issue](https://github.com/yourusername/cpa-master/issues)
